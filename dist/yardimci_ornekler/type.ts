//->type<- anahtar kelimesi sayesinde yeni bir basit tip/model olusturabilirsin
type sayi = number; //Bundan sonra ->number<- yerine ->sayi<- kelimesini kullanabilirsin:
const bu_bir_sayidir: sayi = 9; //ayni anlama geliyor
const bu_baska_sayidir: number = 4;

//-> [] <- liste olusturmak için ve liste turu tipleri belirtmek için kullanilir

const bu_bir_sayi_listesi: sayi[] = []//DIKKAT ET sayi DIYORUM CUNKU sayi TIPINI number tipi ile ayni anlama getirdim!


type yazi = string;

const isim: yazi = "Tuncay" //Ayni sekilde
const baska_isim: string = "Ibrahim"

////////////////////////////////////////////////////////////////////////--//->Bos bir yazi dizisi de olabilir ->""<-
const bu_bir_yazi_listesi: yazi[] = [isim, baska_isim, "Pala", "Seyfo", ""] //Bir yazi(string) listesi olusturup içine yazilari bu sekilde koyabilirsin
...
const bos_bir_liste: any[] = [] //Bu liste farkindaysan ->any<- tipi ile olusturuldu, any herhangi demek, yani içine ne istersen koyabilirsin

let bir_sey: any; //Dikkat ->let<- kullandim yani bu degisebilir, ama const degismez, mesela isim="Tuncay" artik programin sonuna kadar oyle kalacak

bir_sey = 5//içne sayi koydum;
bir_sey = "lol"//yazi dizisi koydum;
bir_sey = [] //bos bir liste koydum...

let bir_yazi: string //simdi bir_yazi degiskeninin içine her turlu yaziyi koyabilirim, ama baska bir sey koyamam
bir_yazi = "hey"//OK // bir_yazi=5 -> Error: yazi degiskenine sayi koyamazsin


//Listelerin bazi methodlari ->METHOD<- yani bir degiskenin sonuna .(nokta) koyarak ulasabilecegin ozel fonksiyonlar
//Bir de field dedigimiz ozel degiskenler var, ayni pirensip, .(nokta) ile ulasiyorsun ve o degiskene ozel

//Mesela
type Meyve = "elma" | "armut" | "portakal" | "mandalina" ///Bu artirilabilir, bu sayede butun meyveleri temsil eden bir tip olusturabilirsin

const meyve_listesi: Meyve[] = [] //Bos bir meyve listesi
